...
\section{Lijsten}
  ...
  \py{append} is een tikkeltje sneller).
...
\section{Strings}
  ...
  tekst-specifieke functie gebruiken. Gebruik \py{dir(\char`"\char`")} voor
  meer info.
...
\section{Verwijzingen (extra)}\label{sec:pointers}
  ...
  \py{a} en \py{b} maar wel aan de data waarnaar ze verwijzen. Op het einde
  ...
  onveranderlijke dingen te vergelijken. Als je toch \py{is} gebruikt wees dan
